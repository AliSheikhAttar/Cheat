...
class Product(models.Model):
    ...
    last_update = models.DateTimeField(auto_now=True) # last update date automatically save
...
class Customer(models.Model):
    ...
    email = models.EmailField(unique=True) # is unique
...
class Order(models.Model):
    ...
    placed_at = models.DateTimeField(auto_now_add=True) # auto_now_add => creation date saved
